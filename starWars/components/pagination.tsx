  ...
  return (
    <div className="pagination" title="Pagination">
      {result.previous !== null && detail !== undefined && (
        <Link
          className="link-page"
          href={`/?search=${search}&page=${(result.previous as string).split('page=')[1]}&detail=${detail}`}
      ...
      {result.previous !== null && detail === undefined && (
        <Link
          className="link-page"
          href={`/?search=${search}&page=${(result.previous as string).split('page=')[1]}`}
          key={(result.previous as string).split('page=')[1]}
        >
          {(result.previous as string).split('page=')[1]}
        </Link>
      ...
      {result.next !== null && detail !== undefined && (
        <Link
          className="link-page"
          href={`/?search=${search}&page=${(result.next as string).split('page=')[1]}&detail=${detail}`}
      ...
      {result.next !== null && detail === undefined && (
        <Link
          className="link-page"
          href={`/?search=${search}&page=${(result.next as string).split('page=')[1]}`}
          key={(result.next as string).split('page=')[1]}
        >
          {(result.next as string).split('page=')[1]}
        </Link>
